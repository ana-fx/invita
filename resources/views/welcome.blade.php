...
<body class="bg-gradient-to-br from-gray-100 to-white">
    <div class="flex items-start">
        <div class="container mx-auto px-4 pt-0 pb-4">
            <div class="grid grid-cols-1 lg:grid-cols-12 gap-0 items-start">
                <!-- Left Content -->
                <div class="lg:col-span-5 px-5 pt-8 pb-4 lg:pt-12 lg:pb-4">
                    <!-- Wedding Icon -->
                    <div class="mb-6">
                ...
                <div class="lg:col-span-7 relative px-0">
                    <!-- Photo Section -->
                    <div class="relative mt-4 lg:mt-6">
                        <div class="relative overflow-hidden shadow-lg" style="border-top-left-radius: 250px;">
                                ...
                                <img src="https://images.unsplash.com/photo-1583939003579-730e3918a45a?q=80&w=800&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D"
                                     alt="Brandon & Meyca"
                                 class="w-full h-[500px] lg:h-[600px] object-cover grayscale brightness-110">
    ...
    <!-- Bride & Groom Section -->
    <section class="bg-white pt-4 pb-4 relative overflow-hidden">
            ...
            <div class="flex flex-col md:flex-row items-center justify-center gap-4 sm:gap-6 md:gap-6 lg:gap-10 xl:gap-14 2xl:gap-16">
                ...
                <div class="flex flex-col items-center md:flex-row md:gap-2 lg:gap-4 xl:gap-6 md:items-center md:justify-end w-full md:w-auto md:flex-1 lg:flex-none">
                    <div class="text-center md:text-right mb-4 sm:mb-5 md:mb-0 order-2 md:order-1 w-full md:w-auto md:max-w-full overflow-hidden px-2 md:px-0 relative">
                        ...
                        <h2 class="text-3xl sm:text-4xl md:text-5xl lg:text-6xl xl:text-7xl 2xl:text-7xl font-bold text-gray-900 playfair mb-1 sm:mb-2 break-words leading-tight relative" style="writing-mode: vertical-rl; text-orientation: mixed;">
                            <span class="relative z-10">Meyca</span>
                        </h2>
                        <p class="text-[10px] sm:text-xs tracking-widest text-gray-600 font-normal mb-2 sm:mb-3 md:mb-4" style="writing-mode: vertical-rl; text-orientation: mixed;">THE BRIDE</p>
                    </div>
                    <!-- Bride Photo with Rounded Corner -->
                    <div class="order-1 md:order-2 flex flex-col items-center w-full md:w-auto">
                        <div class="relative w-full md:w-[300px] lg:w-[380px] xl:w-[450px] 2xl:w-[500px] h-[500px] lg:h-[600px] flex-shrink-0 group overflow-hidden shadow-xl rounded-tr-[80px] sm:rounded-tr-[100px] md:rounded-tr-[120px] lg:rounded-tr-[140px] xl:rounded-tr-[160px]">
                ...
                <div class="flex flex-col items-center md:flex-row md:gap-2 lg:gap-4 xl:gap-6 md:items-center md:justify-start w-full md:w-auto md:flex-1 lg:flex-none">
                    ...
                    <div class="order-1 md:order-1 flex flex-col items-center w-full md:w-auto">
                        <div class="relative w-full md:w-[300px] lg:w-[380px] xl:w-[450px] 2xl:w-[500px] h-[500px] lg:h-[600px] flex-shrink-0 group overflow-hidden shadow-xl rounded-tl-[80px] sm:rounded-tl-[100px] md:rounded-tl-[120px] lg:rounded-tl-[140px] xl:rounded-tl-[160px]">
                    ...
                    <div class="text-center md:text-left order-2 md:order-2 w-full md:w-auto md:max-w-full overflow-hidden px-2 md:px-0 relative">
                        ...
                        <p class="text-[10px] sm:text-xs tracking-widest text-gray-600 font-normal mb-2 sm:mb-3 md:mb-4" style="writing-mode: vertical-rl; text-orientation: mixed;">THE GROOM</p>
                    </div>
                </div>
            </div>
        </div>
